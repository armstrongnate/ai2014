...
namespace ai
{
  namespace Agent
  {
    ...
    void EnvironmentDisplay::DrawText(int x, int y, char *str)
    {
      DrawText((float) x, (float) y, str);
    }

    void EnvironmentDisplay::DrawText(float x, float y, char *str)
    {
    ...
    {
      DrawCircle((float) x1, (float) y1, (float) radius);
    }
...
namespace ai
{
  namespace Agent
  {
    ...
    EnvironmentDisplay::EnvironmentDisplay(Environment *env)
    {
    }
    EnvironmentDisplay::~EnvironmentDisplay()
    {
