                   ...
                   bool show_solution)
{
  ...
  switch(the_frontier_type)
    {
    case BFS:  the_frontier = new ai::Search::BFFringe(); id += "BFS"; break;
    case UCS:  the_frontier = new ai::Search::UCFringe(); id += "UCS"; break;
    case DFS:  the_frontier = new ai::Search::DFFringe(); id += "DFS"; break;
    case DLS:  the_frontier = new ai::Search::DLFringe(max_depth); id += "DLS:"; id += dstring; break;
    case IDS:  the_frontier = new ai::Search::DLFringe(max_depth); id += "IDS:"; id += dstring;  break;
    default:
